...
public class Project_Multi_Thread {
    ...
    public  static class ForBankEmployeeThread extends  Thread{
        Customer customer;
...
// Before Exiting the Bank Employee Section first store the Bank_Employee  MAP   data
    ...
    public  static class LoanThread extends Thread{
        Customer customer;
        Bank_Employee bank_employee;
        ...
        public void run() {
            ...
            ObjectInputStream s3 = null;
            try {
                s3 = new ObjectInputStream(f3);
            } catch (IOException e) {
                e.printStackTrace();
            }
            try {
    ...
    public static class FileingThread extends Thread{
        @Override
        public void run() {
    ...
    public static class NewCustomerRegistrationThread extends Thread{
        @Override
        public void run() {
            Customer customer;
            Bank_Employee bank_employee;
...

            {
                ...
                switch(choice)
                {
                    case 1:
                        ...
                        ForBankEmployeeThread bankEmployeeThread=new ForBankEmployeeThread();
                        bankEmployeeThread.run();
                        break;
                    case 2:
                        NewCustomerRegistrationThread newCustomerRegistrationThread=new NewCustomerRegistrationThread();
                        newCustomerRegistrationThread.run();
                        break;
                    case 3:
...
//
        ...
        public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
            ...
            FileingThread fileingThread=new FileingThread();
            fileingThread.run();
Thread.sleep(3000);
